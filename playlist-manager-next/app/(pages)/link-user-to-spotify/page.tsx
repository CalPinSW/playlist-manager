...
export default function Index() {
    ...
    return (
        <div className='flex flex-col items-center justify-center'>
            ...
            <button className='m-3 p-4 bg-primary rounded-sm cursor-pointer' onClick={linkToSpotifyHandler}>Click to Connect</button>
            <button className='m-3 p-4 bg-primary rounded-sm cursor-pointer' onClick={refreshUserDataHandler}>Refetch User Data</button>
        </div>
    );
}