...
const SearchBar: FC<SearchBarProps> = ({ title, search, setSearch }) => {
  ...
  return (
    <div className="w-full flex space-x-4">
      <div>{title}</div>
      <input
        className="w-full py-1 border-solid border border-primary-lighter bg-background-offset rounded-md"
        type="text"
